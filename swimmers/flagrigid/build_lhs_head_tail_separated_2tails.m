function lhs = build_lhs_head_tail_separated_2tails(G,Gamma1,Gamma2,Gamma3,phi1,phi2,phi3,x_S);
...
%         | 0 0 ... 0 0 0 ... 0 1 .... 1 |
g=@(X) ones(size(X,1),1);
lhs21 = sparse(3,3*(Ndof1+Ndof2+Ndof3));
...
lhs21(3,3*Ndof1+2*Ndof2+1:3*(Ndof1+Ndof2)) = integral(Gamma2,phi2,g);

lhs21(1,3*(Ndof1+Ndof2)+1:3*(Ndof1+Ndof2)+Ndof3) = integral(Gamma3,phi3,g);
lhs21(2,3*(Ndof1+Ndof2)+Ndof3+1:3*(Ndof1+Ndof2)+2*Ndof3) = integral(Gamma3,phi3,g);
lhs21(3,3*(Ndof1+Ndof2)+2*Ndof3+1:end) = integral(Gamma3,phi3,g);

lhs{2,1} = lhs21;
lhs{1,2} = lhs21'; % dec 2019
...
lhs13 =  sparse(3*(Ndof1+Ndof2+Ndof3),3);
...
lhs13(3*Ndof1+2*Ndof2+1:3*(Ndof1+Ndof2),1)  =  0.5*integral(Gamma2,phi2,r2);
lhs13(3*Ndof1+2*Ndof2+1:3*(Ndof1+Ndof2),2)  = -0.5*integral(Gamma2,phi2,r1);

lhs13(3*(Ndof1+Ndof2)+1:3*(Ndof1+Ndof2)+Ndof3,2)        =  0.5*integral(Gamma3,phi3,r3);
lhs13(3*(Ndof1+Ndof2)+1:3*(Ndof1+Ndof2)+Ndof3,3)        = -0.5*integral(Gamma3,phi3,r2);
lhs13(3*(Ndof1+Ndof2)+Ndof3+1:3*(Ndof1+Ndof2)+2*Ndof3,1) = -0.5*integral(Gamma3,phi3,r3);
lhs13(3*(Ndof1+Ndof2)+Ndof3+1:3*(Ndof1+Ndof2)+2*Ndof3,3) =  0.5*integral(Gamma3,phi3,r1);
lhs13(3*(Ndof1+Ndof2)+2*Ndof3+1:end,1)  =  0.5*integral(Gamma3,phi3,r2);
lhs13(3*(Ndof1+Ndof2)+2*Ndof3+1:end,2)  = -0.5*integral(Gamma3,phi3,r1);


lhs{1,3} = 2*lhs13; % dec 2019
lhs{3,1} = 2*lhs13';
